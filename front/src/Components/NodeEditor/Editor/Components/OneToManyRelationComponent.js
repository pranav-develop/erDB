...
export class OneToManyRelationComponent extends Rete.Component {
    constructor() {
        super("One To Many Relation");
    }
    ...
    worker(node, inputs, outputs) {
        var relationDescription = inputs.relationInput1[0] + " (One) To " + inputs.relationInput2[0] + " (Many)";
        this.editor.nodes
            .find((n) => n.id === node.id)
